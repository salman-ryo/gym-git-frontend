...
const ContributionGraph = dynamic(() => import('@/components/pages/dashboard/ContributionGraph'), { ssr: false });
const PowerLevelChart = dynamic(() => import('@/components/pages/dashboard/PowerLevelChart'), { ssr: false });
const RewardRoadmap = dynamic(() => import('@/components/pages/dashboard/rewards/RewardRoadmap'), { ssr: false });
    ...
    <AuthGuard>
      <div className="min-h-screen text-[#fafafa] flex flex-col font-sans relative overflow-hidden selection:bg-neon-green/20 selection:text-neon-green">
        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          <main className="flex-1 max-w-7xl w-full mx-auto px-3.5 py-6 sm:p-6 lg:p-8 space-y-7 sm:space-y-8">
