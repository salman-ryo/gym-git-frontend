...
import { X, Snowflake, AlertCircle, ShieldAlert } from 'lucide-react';
...
export default function FreezeModal({
  ...
  return (
    <>
      ...
      >
        <div
          className="relative w-full max-w-lg bg-[#080c10]/95 border border-[rgba(34,211,238,0.25)] rounded-3xl shadow-[0_0_50px_rgba(34,211,238,0.15)] flex flex-col max-h-[90vh] overflow-hidden animate-in scale-in-95 duration-200"
        ...
        >
          ...
          <button
            type="button"
            onClick={onClose}
            className="absolute top-5 right-5 z-20 text-zinc-400 hover:text-neon-cyan p-2 rounded-xl bg-zinc-950/80 border border-zinc-800 hover:border-neon-cyan/40 backdrop-blur-sm transition-all cursor-pointer group"
          >
          ...
          <div className="flex-1 overflow-y-auto p-6 sm:p-8 custom-scrollbar">
            ...
            {availableTokens <= 0 ? (
              <div className="p-5 rounded-2xl bg-zinc-950/50 border border-zinc-800/60 flex flex-col items-center text-center space-y-4 my-4">
              ...
              <div className="space-y-6">
                {/* Error Banner */}
                {errorMsg && (
                  <div className="p-3.5 rounded-xl bg-red-950/20 border border-red-500/30 text-red-200 text-xs flex gap-2 items-center">
