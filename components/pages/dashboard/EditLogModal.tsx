...
// --- NEW COMPONENT: Cyberpunk HUD Dial ---
...
const CyberDial: React.FC<CyberDialProps> = ({ value, onChange, max = 6, step = 0.25 }) => {
  ...
  return (
    <div className="relative flex justify-center items-center my-6 group">
      ...
      >
        {/* Background Track - FIXED SYNTAX ERROR HERE */}
        <circle
          cx="100"
          cy="100"
          r={radius}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-950/85 backdrop-blur-xl animate-in fade-in duration-200">
      <div className="w-full max-w-md bg-[#080c10]/95 border border-[rgba(0,255,136,0.2)] rounded-3xl p-6 sm:p-7 shadow-[0_0_50px_rgba(0,0,0,0.9)] relative animate-in scale-in-95 duration-200">
        ...
        <div className="space-y-6">
          ...
          {/* Duration: HUD Dial + Custom Toggle */}
          <div>
            ...
            <div className="flex justify-center">
              <button
                ...
                className={`py-1.5 px-4 text-[10px] font-black rounded-full transition-all border flex items-center gap-1.5 cursor-pointer uppercase tracking-widest ${isCustomHours
