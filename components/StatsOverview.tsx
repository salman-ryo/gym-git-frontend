    ...
    <TooltipProvider delayDuration={50}>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-zinc-900/80 border border-zinc-800 p-5 rounded-2xl relative overflow-hidden group hover:border-emerald-500/50 transition-all">
          ...
          <p className="text-[11px] text-zinc-500 mt-1">Best plan-compliant sequence</p>
        </div>
        ...
        <div className="bg-zinc-900/80 border border-zinc-800 p-5 rounded-2xl relative overflow-hidden group hover:border-teal-500/50 transition-all">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-sm font-medium text-teal-400">Compliance</span>
          </div>
          <p className="text-[11px] text-zinc-400 mt-1 font-semibold flex items-center gap-1">
            <CheckCircle2 className="w-3.5 h-3.5 text-teal-400" />
            <span>
              This Week: {streak?.currentWeekDone || 3}/{streak?.currentWeekTarget || 4} Workouts ({streak?.currentWeekStatus || 'On Track'})
            </span>
          </p>
        </div>
